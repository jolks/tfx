...
class Executor(base_executor.BaseExecutor):
  ...
  class _ToArrowTablesFn(beam.DoFn):
    """Converts a batch of serailized examples to an Arrow Table."""
  ...
  def _FromDictsToArrowTables(
      pcoll: beam.pvalue.PCollection,
      schema: schema_pb2.Schema) -> beam.pvalue.PCollection:
    """Converst Dicts to Arrow Tables."""

    def ToLegacyTFDV(element, feature_specs):
    ...
    return (
        ...
        >> beam.Map(ToLegacyTFDV, feature_specs=feature_specs_from_schema)
